...
const canvasBg = '#2e2930';

// Define colors for hour, minute and second hand
const hourActiveColor = '#badcad',
	minuteActiveColor = '#a2d7dd',
	secondActiveColor = '#e6cde3';

// Define inactive colors for hour, minute and second hand
const hourInactiveColor = '#16160e',
	minuteInactiveColor = '#2b2b2b',
	secondInactiveColor = '#474a4d';

const timerBg = '#2b2b2b';
